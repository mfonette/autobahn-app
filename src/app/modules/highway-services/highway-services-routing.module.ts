...
const routes: Routes = [
  ...
  {
    path: 'parking-lorries',
    component: ParkingLorriesComponent,
    canActivate: [HighwayResetGuard],
  },
  {
    path: 'electric-charging-stations',
    component: ElectricChargingStationsComponent,
    canActivate: [HighwayResetGuard],
  },
];
